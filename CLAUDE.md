...
src/
  ...
  server/
    index.ts          ← Phase 8: Express web server; /session, /message, /confirm, /stream (SSE), /report
...
| `npm test` | Unit tests — 86 tests, no API calls, ~2s |
...
- Always run `npm test` — all 86 tests must pass
